...
Army::Army(std::string img, float x, float y, float radius, float speed, float hp, int Price) :
	Engine::Sprite(img, x, y), speed(speed), hp(hp), Price(Price) {
...
void Army::UpdatePath(const std::vector<std::vector<int>>& mapDistance) {
